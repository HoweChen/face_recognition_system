...
if __name__ == '__main__':
    ...
    test_dataset_list = [
        "/Users/howechen/Dropbox/Lab/dataset/CV/classified_yale_b/same_horizontal_degree",
        "/Users/howechen/Dropbox/Lab/dataset/CV/classified_yale_b/same_vertical_degree"
    ]

    with open("./yale_b_result.txt", mode="w") as f_open:
        # r.flushall()
        watermark = False
